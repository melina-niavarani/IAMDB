<template>
    <div>
        <section class="mb-2 md:flex md:justify-center md:items-center md:space-x-3 ">
            ...
            <div @click="getMoviesInfo" class="bg-accent-color py-3 mt-3 mb-[199px] w-full flex justify-center items-center rounded-[100px] hover:bg-accent-hover hover:cursor-pointer outline-none md:mb-0 md:mt-0 md:py-[18px] md:w-[162px]">
...
export default {
    ...
    methods: {
        GoToInfo(){
            this.$router.push(`/details/${this.movies.id}`)
        },
        getMoviesInfo(){
